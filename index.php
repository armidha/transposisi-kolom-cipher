...
<html lang="en">
  ...
  <body>
	...
	<table class="table table-hover" style="width:100%; padding:10px;">
		<tr>
			<td colspan="3">
				<h1 style="text-align:center;">TRANSPOSITION CIPHER</h1>
        <a href="transposition.php">Enkripsi | </a>
		...
		<tr>
			...
			<td>:</td>
			<td>
				<input id="key"class="form-control" name="key" size="10" placeholder="misal: zebra" type="text"> 
			</td>
		</tr>
		<tr>
			<td colspan="3">
